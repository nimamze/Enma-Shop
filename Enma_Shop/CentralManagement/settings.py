...
ORDER_DEFAULT_SHIPPING_AMOUNT = int(os.getenv("ORDER_DEFAULT_SHIPPING_AMOUNT", 0))
ORDER_FREE_SHIPPING_THRESHOLD = int(
    os.getenv("ORDER_FREE_SHIPPING_THRESHOLD", 0)
)
...
ZARINPAL_TIMEOUT = int(os.getenv("ZARINPAL_TIMEOUT", 15))
